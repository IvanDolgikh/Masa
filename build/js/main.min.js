...
},{"./accordion/init-accordion":2,"./menu":4,"./modules/form-validate/form":6,"./modules/modals/init-modals":12,"./sliders":14,"./utils/ios-vh-fix":17,"./vendor":19}],4:[function(require,module,exports){
"use strict";

var button = document.querySelector('.main-header__button-open-menu');
var openIcon = document.querySelector('.main-header__button-open-menu-icon');
var closeIcon = document.querySelector('.main-header__button-close-menu-icon');
var navContainer = document.querySelector('.main-header__nav-list-container');
...
var onOpenMenu = function onOpenMenu() {
  changeClasses();
};
...
var onClickOutside = function onClickOutside(evt) {
...
exports.swiperPrograms = exports.swiperNews = exports.swiperHero = void 0;
var swiperHero = new Swiper('.swiper-1', {
...
var swiperPrograms = new Swiper('.swiper-2', {
  direction: 'horizontal',
  loop: false,
  slidesPerView: 3,
  spaceBetween: 32,
...
exports.swiperPrograms = swiperPrograms;
var swiperNews = new Swiper('.swiper-3', {
  direction: 'horizontal',
  loop: false,
  slidesPerView: 2,
  spaceBetween: 32,
